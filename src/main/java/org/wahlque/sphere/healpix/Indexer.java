...
public class Indexer {
    ...
    public static int ringByRind(int level, int index) {
        int ring = -1, size = power(level), ncap = 2 * size * (size - 1), nblt = ncap
                + 4 * size * size, equt = nblt + 4 * size, sblt = 12 * size
                * size - ncap, scap = 12 * size * size;
    ...
    public static int pxirByRind(int level, int index) {
        int pxir = -1, size = power(level), ncap = 2 * size * (size - 1), scap = 12
                * size * size, ring = ringByRind(level, index);
